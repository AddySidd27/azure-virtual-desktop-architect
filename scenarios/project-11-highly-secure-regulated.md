...
**What this engagement actually taught.** The most dangerous audit finding was not the one that looked most technically serious. Missing hardening felt like the big problem going in; the broken break-glass process, discovered almost by accident during the assessment, was the one that could have caused a genuine incident with no way to respond to it. The lesson worth carrying forward: audit findings that involve "we have a documented process for X" deserve their own verification step, separate from reviewing the document, because a process that has never been tested is not actually a working process, it is a belief that one exists.

**What would be done differently with more time.** The proportionality decisions in section 5 were made through discussion with clinical leadership, which was the right process but took longer than budgeted, three weeks instead of the one week planned, because the first proposal (screen-capture protection enabled by default) had to be walked back after clinical pushback that could have been anticipated with earlier stakeholder involvement. Bringing clinical leadership into the control-design conversation from day one, rather than presenting a security-first draft for their reaction, would likely have reached the same proportionate outcome faster and with less friction.
