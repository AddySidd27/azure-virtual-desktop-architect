# Share-level RBAC. Layer one of the two-layer permission model Lab 5 and
# Chapter 20 cover. Layer two (NTFS) is applied inside the share after the
# centralus domain controller can authenticate to it, in Step 4.
